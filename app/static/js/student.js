...
async function fetch_students(limit, offset, datas) {
    ...
    students.forEach(student => {
        ...
        <tr>
          ...
          <td class="text-center font-bold"><img src="/static/profiles/student/${student.picture_uri}" alt=""
...
function fill_student_update_form(student_data) {
    ...
    imagePreview.src = "/static/profiles/student/" + student_data.picture_uri;
